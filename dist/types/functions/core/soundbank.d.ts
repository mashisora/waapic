...
export declare namespace ConvertExternalSources {
    interface Arguments {
...
export declare namespace GetInclusions {
    interface Arguments {
...
export declare namespace ProcessDefinitionFiles {
    interface Arguments {
        /** An array of SoundBank definition files. */
        files: string[];
    }
}
export declare namespace SetInclusions {
    interface Arguments {
        /** The ID (GUID), name, or path of the SoundBank to add an inclusion to. */
        soundbank: string;
