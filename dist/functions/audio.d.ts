...
declare namespace ImportTabDelimited {
    interface Arguments {
        /** Object ID (GUID), name, or path used as root relative object paths. */
        importLocation?: string;
...
declare namespace GetMinMaxPeaksInRegion {
    interface Arguments {
...
declare namespace GetMinMaxPeaksInTrimmedRegion {
    interface Arguments {
...
declare namespace SetActiveSource {
    interface Arguments {
