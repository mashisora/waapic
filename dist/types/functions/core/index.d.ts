...
export interface ICoreFunctions extends IObjectFunctions, IAudioFunctions, ISoundbankFunctions, ISwitchFunctions, ITransportFunctions {
...
export declare namespace GetProjectInfo {
    interface Result {
        /** The Project name. */
        name: string;
