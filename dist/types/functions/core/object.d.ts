...
export declare namespace GetAttenuationCurve {
    interface Arguments {
...
export declare namespace GetPropertyAndReferenceNames {
    interface Arguments {
...
export declare namespace GetPropertyInfo {
    interface Arguments {
        /** The ID (GUID), name, or path of the object to watch. */
        object?: string;
...
export declare namespace GetTypes {
    interface Result {
...
export declare namespace IsPropertyEnabled {
    interface Arguments {
...
export declare namespace PasteProperties {
    interface Arguments {
        /** The ID (GUID), name, or path of the source object. */
        source: string;
...
export declare namespace SetAttenuationCurve {
    interface Arguments {
        /** The ID (GUID), name, or path of attenuation object. */
        object: string;
...
export declare namespace SetName {
    interface Arguments {
...
export declare namespace SetNotes {
    interface Arguments {
...
export declare namespace SetRandomizer {
    interface Arguments {
...
export declare namespace SetReference {
    interface Arguments {
