export namespace Imoprt {
  export interface MySchema {
    ...
    default?: {
      ...
      /** Path to media file to import. This path must be accessible from Wwise. For using WAAPI on Mac, please refer to \ref waapi_path_on_mac . */
      audioFile?: string;
      ...
      objectPath?: string;
      /** Specifies the type of object to create when importing an audio file. This type can also be specified directly in the objectPath. Refer to \ref wobjects_index for the available types. */
      objectType?: string;
    ...
    imports: {
      ...
      /** Specifies the 'originals' sub-folder in which to place the imported audio file. This folder is relative to the 'originals' folder in which the file would normally be imported. Example: if importing an SFX, then the audio file is imported to the folder Originals\\SFX\\originalsPath. */
      originalsSubFolder?: string;
      /** The path and name of the object(s) to be created. The path uses backslashes and can either be absolute or relative. Object types can be specified before the name. For example: \verbatim \\Actor-Mixer Hierarchy\\Default Work Unit\<Random Container>MyContainer\<Sound>MySound. \endverbatim */
      objectPath: string;
