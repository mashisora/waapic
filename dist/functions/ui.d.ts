...
declare namespace Register {
    interface Arguments {
        ...
        commands: {
            ...
            startMode?: 'SingleSelectionSingleProcess' | 'MultipleSelectionSingleProcessSpaceSeparated' | 'MultipleSelectionMultipleProcesses';
...
declare namespace GetSelectedObjects {
